...
import './SelectedPeriodItem.scss';

// import { selectorData as applicationSlice } from './../../../../../../../../../../redux/applicationSlice.js';

import { get_date_now_as_string_YYYY_MM_DD } from './../../../../vendors/get_date_now_as_string_YYYY_MM_DD.js';


const SelectedPeriodItemComponent = ( props ) => {
    ...
    useEffect( () => {
        if( isOpen ){
            ...
            let nowDate = get_date_now_as_string_YYYY_MM_DD();
    ...
    return (
        <div className = 'ARC_item_period_num'>
...
export function SelectedPeriodItem( props ){
