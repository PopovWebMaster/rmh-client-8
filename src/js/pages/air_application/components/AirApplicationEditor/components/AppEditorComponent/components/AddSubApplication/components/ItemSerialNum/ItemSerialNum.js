...
const ItemSerialNumComponent = ( props ) => {
    ...
    return (
        <div className = 'NSA_item_serial_num'>
            <h3>Номера серий:</h3>
            ...
            <span className = 'NSA_item_serial_num_count'>всего серий: { numTo - numFrom + 1 }</span>
        </div>
...
export function ItemSerialNum( props ){
