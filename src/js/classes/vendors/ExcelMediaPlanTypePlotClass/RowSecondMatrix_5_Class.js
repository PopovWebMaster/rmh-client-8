...
export class RowSecondMatrix_5_Class extends RowClass {
    ...
    Create(){
        ...
        this.AddRange( `B${this.rowNumber}:C${this.rowNumber+1}` );
        this.AddRange( `D${this.rowNumber}:E${this.rowNumber+1}` );
